...
## Оценка ресурсов (данные берутся пиковые, чтобы оценить ресурсы в сезон)

### Capacity

- (40 + 115 + 71.2 + 2) * 86 400 * 365 = 7.3 ТБ

#### DISKS

Суммарный RPS без учета CDN и S3 **11 070**

- 11 070 / 100 = 111 HDD disks
- 11 070 / 1 000 = 12 SATA DISKS
- 11 070 / 10 000 = 2 nVME DISKS

- 70 МБ/с (суммарный траффик записи и чтения) => 100 МБ/с = 1 disk
- 7.3 ТБ / 2 TБ = 3.7 disks 

Выбор в пользу 12 SATA DISKS по 2 TБ.

...
- Сезонность: Да, сезон отпусков и крупные праздники;
- Тайминги
  - Публикация поста 
    - **Regular (p95)**: *400–800 мс*;
    - **Peak (p99)**: *1200–2500 мс*;
  - Пресайнд URL + загрузка CDN (S3)
    - **Regular (p95)**: *70–150 мс*
    - **Peak (p99)**: *200–400 мс*	
  - Просмотр ленты	
    - **Regular (p95)**: *200–500 мс*	
    - **Peak (p99)**: *800–1500 мс*
  - Реакции	
    - **Regular (p95)**: *50–100 мс*	
    - **Peak (p99)**: *150–400 мс*
  - Оставить комментарий	
    - **Regular (p95)**: *80–200 мс*	
    - **Peak (p99)**: *300–800 мс*
  - Показать комментарии	
    - **Regular (p95)**: *100–300 мс*	
    - **Peak (p99)**: *500–1200 мс*
  - Подписи	
    - **Regular (p95)**: *100–250 мс*	
    - **Peak (p99)**: *400–1000 мс*
  - Поиск по геолокации	
    - **Regular (p95)**: *300–800 мс*	
    - **Peak (p99)**: *1500–3000 мс*	
  - CDN (загрузка фото)	
    - **Regular (p95)**: *50–150 мс*	
    - **Peak (p99)**: *200–500 мс*
- Лимиты
...
| Показать комментарии | 2 893 / 3 356  | 3 / 3.6 ТБ      | ≈ 287 / 317.5       |
|                      |                |                 |                     |
| Реакции              | 1 157 / 3 472  | 3.3 / 9.94 ГБ   | ≈ 0.3 / 0.89        |
| Подписки             | 58 / 64        | 160 / 176.95 МБ | ≈ 0.014 / 0.015     |
|                      |                |                 |                     |
| CDN                  | 4 526 / 7 436  | 1.2 / 2.87 ПБ   | ≈ 112 650 / 265 978 |
...
- Traffic = 3 356 * 10 * 1 240 = 41 614 кБ/с = 317.5 Мбит/с
...
- RPS = 29 + 4 051 + 3 356 = 7 436
- Traffic = (29 * 3 * 2) + (4 051 * 5 * 3 * 0.5) + (4 051 * 5 * 0.05) + (3 356 * 10 * 0.05) = 33 247.25 Мбайт/с = 265 978 Мбит/с
